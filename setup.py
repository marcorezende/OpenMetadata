...
base_requirements = {
    ...
    "idna==2.10",
    "importlib-metadata==6.8.0",  # From airflow constraints
    "Jinja2==3.1.2",
    "jsonpatch==1.32",
    "jsonschema==4.16.0",
    ...
    "PyYAML==6.0",
    "requests==2.31.0",
    "requests-aws4auth==1.2.3",  # Only depends on requests as external package. Leaving as base.
    "setuptools==66.0.0",
    "sqlalchemy==1.4.27",
    "collate-sqllineage==1.2.5",
    "tabulate==0.9.0",
